...
The current `Workload` controller observes resources but does not create runtime objects yet. CRD manifests, generated deepcopy code, and runtime reconciliation are follow-up work.
